...
LIB_LIST=(cmake nasm astyle openssl curl gflags gtest libunwind gperftools libuuid libevent libxml2 log4cplus http_parser protobuf rapidjson mariadb_connector hiredis redis zookeeper aws_sdk_cpp)
